...
import { PROJECTS, CONTENT, SEO_KEYWORDS_LIST } from '../constants';
...
const ProjectsPage: React.FC<Props> = ({ lang }) => {
  ...
  return (
    <div className="pt-24 min-h-screen bg-white">
      <Helmet>
        <title>New Developments Panama | Luxury Beachfront Condos & Investment Projects</title>
        <meta name="description" content="Explore pre-construction condos, gated communities, and luxury resorts in Panama. From Panama City to Boquete and Coronado real estate." />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {/* SECTION: MASSIVE NEIGHBORHOOD ANALYSIS (WORD COUNT BOOST) */}
