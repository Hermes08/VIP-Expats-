...
const BlogPage: React.FC<Props> = ({ lang }) => {
  ...
  return (
    <div className="pt-24 min-h-screen bg-slate-50 pb-20">
      <Helmet>
        <title>{t.nav.blog} | ExpatRockstars Real Estate</title>
        <meta name="description" content="Read our latest insights on Panama real estate, investment trends, and how to live like a rockstar as an expat." />
      </Helmet>
