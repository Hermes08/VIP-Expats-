...
import { PROJECTS, IMAGES, CONTENT, SEO_KEYWORDS_LIST } from '../constants';
...
const HomePage: React.FC<Props> = ({ lang }) => {
  ...
  return (
    <>
      <Helmet>
        <title>ExpatRockstars | Panama Real Estate & Ultra-Luxury Investment Portfolios</title>
        <meta name="description" content="Access trending panama luxury real estate and discovery tours. Specialized in high-ROI assets, residency visas, and relocation services for the savvy global investor." />
      </Helmet>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 w-full pt-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center animate-in fade-in zoom-in duration-1000 delay-700">
              <Link to="/proyectos" className="btn-3d btn-3d-gold px-12 py-6 rounded-full font-black uppercase tracking-[0.2em] text-xs transition-all">
                EXPLORE ASSETS
              </Link>
              <Link to="/tours" className="btn-3d btn-3d-navy px-12 py-6 rounded-full font-black uppercase tracking-[0.2em] text-xs transition-all bg-white/5 backdrop-blur-xl border border-white/10 flex items-center justify-center gap-3">
      ...
      <section className="py-32 bg-black relative">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-10 reveal-on-scroll">
            ...
            <Link to="/proyectos" className="btn-3d btn-3d-gold px-10 py-5 rounded-full font-black uppercase tracking-widest text-[10px]">VIEW ENTIRE INVENTORY</Link>
          </div>
      ...
      <section className="py-40 bg-brand-950 text-center relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-10">
            <Link to="/contacto" className="btn-3d btn-3d-navy px-16 py-8 rounded-full font-black uppercase tracking-[0.3em] text-xs transition-all shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)]">CONTACT A SENIOR ADVISOR</Link>
            <Link to="/tours" className="btn-3d btn-3d-gold px-16 py-8 rounded-full font-black uppercase tracking-[0.3em] text-xs transition-all">BOOK DISCOVERY JOURNEY</Link>
          </div>
        </div>
      </section>
    </>
